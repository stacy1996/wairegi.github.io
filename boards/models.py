...
class Category(models.Model):
    ...
    def get_posts_count(self):
        return Project.objects.filter(project__boards=self).count()

    def get_last_post(self):
        return Project.objects.filter(project__boards=self).order_by('-date_posted').first()
...
class Project(models.Model):
    ...
    aims = models.TextField(null=True)
